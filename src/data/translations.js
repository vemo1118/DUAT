export const TRANSLATIONS = {
  en: {
    ...
    aboutMythLead: 'In the old religion, the Duat is the passage the sun crosses each night — to be reborn at dawn.',
    ...
    aboutSymbolsEyebrow: 'THE ICONOGRAPHY',
    aboutSymbolsTitle: 'Every mark means something.',
    aboutSym1Label: 'Ankh',
    aboutSym1Body: 'Life carried through the dark.',
    aboutSym2Label: 'Scarab',
    aboutSym2Body: 'What buries itself rises again.',
    aboutSym3Label: 'Sun Disc',
    aboutSym3Body: 'The return. Every night ends at dawn.',
    aboutSym4Label: 'Wings',
    aboutSym4Body: 'Protection wrapped around what matters.',
  ...
  ar: {
    ...
    aboutMythLead: 'في المعتقد القديم، الدُوات هو الممر اللي الشمس بتعبره كل ليلة — عشان تُولد من جديد مع الفجر.',
    ...
    aboutSymbolsEyebrow: 'الرموز',
    aboutSymbolsTitle: 'كل رمز ليه معنى.',
    aboutSym1Label: 'عنخ',
    aboutSym1Body: 'الحياة اللي بتتشال في الضلمة.',
    aboutSym2Label: 'الجعران',
    aboutSym2Body: 'اللي بيدفن نفسه بيرجع تاني.',
    aboutSym3Label: 'قرص الشمس',
    aboutSym3Body: 'الرجوع. كل ليل بيخلص عند الفجر.',
    aboutSym4Label: 'الأجنحة',
    aboutSym4Body: 'حماية بتتلف حوالين اللي بيهمّك.',

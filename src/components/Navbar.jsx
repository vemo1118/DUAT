        ...
        <div className="flex items-center justify-between h-20">
              ...
              <NavLink
                ...
                className={({ isActive }) =>
                  `font-mono text-xs uppercase tracking-[0.2em] transition-all duration-200 py-2 min-h-[44px] flex items-center relative group ${
                    isActive ? 'text-gold font-bold' : 'text-bone/90 hover:text-gold'
                  }`
                }
              >
                {({ isActive }) => (
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <button
              ...
              className="hidden sm:flex items-center gap-2 font-mono text-[11px] uppercase tracking-wider text-ash hover:text-gold transition-colors border border-grave bg-stone/50 px-3 py-2 min-h-[44px] rounded-sm"
            ...
            <button
              onClick={toggleTheme}
              className="flex items-center gap-1.5 font-mono text-xs text-ash hover:text-gold border border-grave bg-stone px-2.5 sm:px-3 py-2 transition-colors uppercase min-h-[44px] min-w-[44px] justify-center rounded-sm"
            ...
            <button
              ...
              className="hidden md:flex items-center gap-1.5 font-mono text-xs tracking-widest text-ash hover:text-gold border border-grave bg-stone px-3 py-2 transition-colors uppercase min-h-[44px] rounded-sm"
            ...
            <button
              ...
              className="relative p-2.5 text-bone hover:text-gold transition-colors border border-grave bg-stone hover:border-gold flex items-center justify-center min-h-[44px] min-w-[44px] rounded-sm"
              aria-label="Open Wishlist"
              title={lang === 'ar' ? 'المفضلة' : 'Wishlist'}
            >
              <Heart size={18} className={wishlistCount > 0 ? 'text-gold fill-gold/20' : ''} />
              {wishlistCount > 0 && (
                <span className="absolute -top-1.5 -right-1.5 bg-gold text-void font-mono font-bold text-[10px] w-5 h-5 rounded-full flex items-center justify-center border border-stone shadow-sm">
                  {wishlistCount}
                </span>
              )}
            </button>
            ...
            <button
              ...
              className="md:hidden p-2.5 text-bone hover:text-gold border border-grave bg-stone flex items-center justify-center min-h-[44px] min-w-[44px] rounded-sm"

...
export const ProductCard = ({ product }) => {
  ...
  // Map product categories to photography assets (using clean transparent hero case)
  const getProductImage = () => {
    if (product.category === 'stickers') {
      ...
      // Default cases to new transparent hero case
      return '/images/transparent_hero_case.png';
    }
  };
  ...
  return (
    <div className="bg-stone border border-grave flex flex-col justify-between group relative overflow-hidden transition-all duration-400 hover:border-gold cursor-pointer">
      ...
      {/* 3:4 Aspect Ratio Photography Container */}

  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-6 xl:col-span-5 flex flex-col items-center space-y-4">
          ...
          <div className="w-full max-w-sm aspect-[3/5] bg-stone border border-grave p-4 shadow-2xl relative flex flex-col items-center justify-center select-none overflow-hidden card-depth-highlight">
            ...
            <div
              ...
              className="w-full h-full rounded-[38px] border-2 border-grave relative flex flex-col justify-between p-4 overflow-hidden shadow-xl transition-colors duration-500"
        ...
        {/* RIGHT COLUMN: CONTROLS & TABS (7 cols on xl) */}
        <div className="lg:col-span-6 xl:col-span-7 space-y-6">
          ...
          <div className="bg-stone border border-grave p-6 space-y-6">
            ...
            {/* TAB CONTENTS — RENDER GOLDEN SVG STICKER PREVIEWS (Screenshot 1 Fix) */}
            {activeTab === 'stickers' && (
                ...
                <div className="grid grid-cols-3 sm:grid-cols-4 gap-3">
                  {STICKER_PRESETS.map((st) => (
                    <button
                      ...
                      className="p-3 bg-coal border border-grave hover:border-gold flex flex-col items-center justify-center space-y-2 transition-colors min-h-[76px]"
                    >
                      <StickerIcon stickerId={st.id} size={32} />
